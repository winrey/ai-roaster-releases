...
当前推荐 [0.2.7 正式版](https://github.com/winrey/ai-roaster-releases/releases/tag/v0.2.7)。签名、公证与验证结果见本 Release 的 `BUILD-INFO.txt` / `NOTARIZATION.json`，文件校验值见 `SHA256SUMS.txt`。此前版本的状态以各自 Release 为准。Intel Mac 尚未实机验收。
